...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Couture Panafricaine" },
      { property: "og:title", content: "Couture Panafricaine — L'Art de la Mesure" },
      { property: "og:description", content: "Maison de couture panafricaine sur-mesure. Excellence artisanale, héritage panafricain." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://api.fontshare.com/v2/css?f[]=clash-display@400,500,600&display=swap" },
    ],
  }),
